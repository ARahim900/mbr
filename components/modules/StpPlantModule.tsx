...
import { Recycle, Droplets, Truck, Banknote, Sprout, TrendingUp, DollarSign } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 p-4 sm:p-6">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
                <h1 className="text-3xl font-bold text-primary dark:text-white">STP Plant Operations</h1>
                <p className="text-secondary dark:text-gray-400">Dashboard for Sewage Treatment Plant performance and financial impact.</p>
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-6">
            <MetricCard 
                title="Inlet Sewage"
                value={selectedMonthData.totalInletSewage.toLocaleString()}
                unit="m³"
                icon={Droplets}
                subtitle={`For ${selectedMonthData.month}`}
                iconColor="text-blue-500"
            />
            <MetricCard 
                title="TSE for Irrigation"
                value={selectedMonthData.tseOutput.toLocaleString()}
                unit="m³"
                icon={Sprout}
            ...
            <MetricCard 
                title="Tanker Trips"
                value={selectedMonthData.tankerCount.toLocaleString()}
                unit="trips"
                icon={Truck}
            ...
            <MetricCard 
                ...
                value={selectedMonthData.income.toLocaleString(undefined, {minimumFractionDigits: 2})}
                unit="OMR"
                icon={Banknote}
            ...
            <MetricCard 
                title="Water Savings"
                value={selectedMonthData.savings.toLocaleString(undefined, {minimumFractionDigits: 2})}
                unit="OMR"
                icon={TrendingUp}
            ...
            />
             <MetricCard 
                title="Total Impact"
                value={selectedMonthData.totalSavingsAndIncome.toLocaleString(undefined, {minimumFractionDigits: 2})}
                unit="OMR"
                icon={DollarSign}
        ...
        {/* Charts */}
         ...
         {/* Daily Log Table */}
        <ChartCard title={`Daily Operations Log for ${selectedMonthData.month}`}>
