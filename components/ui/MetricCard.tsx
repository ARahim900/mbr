...
const MetricCard: React.FC<MetricCardProps> = ({ 
  ...
  return (
    <div className="group bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm shadow-lg rounded-2xl p-6 border border-gray-100 dark:border-gray-700 transition-all duration-300 hover:shadow-2xl hover:scale-[1.02] overflow-hidden relative">
      ...
      <div className="relative flex items-start space-x-4">
        <div className={`p-4 rounded-2xl bg-gradient-to-br ${getIconBackground()} shadow-lg group-hover:shadow-xl transition-all duration-300`}>
          <Icon className="w-6 h-6 text-white" />
        </div>
        
        <div className="flex-1">
          <p className="text-sm font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider mb-1">
            {title}
          </p>
